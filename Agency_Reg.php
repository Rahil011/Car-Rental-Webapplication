...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST["email"]) && empty($_POST["password"]) && empty($_POST["name"])) {
        ...
        $exists = "SELECT * FROM `agency` WHERE agency_Email='$email'";
        ...
        if ($exnum > 0) {
            ...
            $sql = "INSERT  INTO `agency` (`agency_Email`, `agency_Name`, `agency_Password`,`agency_Phone` ) VALUES ('$email', '$name', '$hash','$phone')";
            ...
            <div class="row mt-1 w-75">
                <form method="POST">
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control" id="name" placeholder="Enter your Agency name"
                            name="name">
                    </div>
                    <div class="form-group mb-2">
                        <label for="phone">Phone Number</label>
                        <input type="tel" class="form-control" id="phone" placeholder="Enter your Agency number"
                            name="phone">
                    </div>
                    <div class="form-group mb-2">
